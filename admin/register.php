...
<head>
    ...
    <title>Hospital Management Doctor Registration Page</title>
    <style>
        /* General Reset */
body {
    margin: 0;
...
<div class="login-container">
        <div class="logo">
            <img src="../user/img/logo.png" alt="Hospital Logo">
        </div>
        ...
        <form class="login-form" action="" method="post" enctype="multipart/form-data">
            ...
            <input type="number"  placeholder="Experience"  name="experience" required>
            ...
            <?php
                if(isset($_POST['submit']))
                {
                    $response=registerDoctor($_POST);
                        ...
                        {
                            echo "Doctor Image not Uploaded";
                        }
                        else
                        {
                            echo "error";
